    ...
    return (
      <div className="flex items-center justify-center h-screen">
        <div className="text-center p-8 max-w-lg">
          <h1 className="text-3xl font-bold mb-4 text-amazon-blue">
    ...
    return (
      <div className="container mx-auto px-4 py-8 bg-gray-50 min-h-screen">
        <div className="max-w-3xl mx-auto bg-white p-6 rounded-lg shadow-sm border-l-4 border-yellow-500">
          <h1 className="text-2xl font-bold mb-4 text-amazon-blue">
            Mensaje no encontrado
          </h1>
          <p className="text-gray-700 mb-4">
            El mensaje solicitado no existe o ha sido eliminado.
          </p>
          <a
            href="/admin/mensajes"
            className="inline-block px-4 py-2 bg-amazon-blue text-white rounded hover:bg-amazon-blue-dark transition-colors"
  ...
  return (
    <div className="container mx-auto px-4 py-8 bg-gray-50 min-h-screen">
      <div className="max-w-5xl mx-auto">
        {" "}
        {/* Aumentado de 3xl a 5xl para hacerlo más ancho */}
        {/* Tarjeta del mensaje */}
        <div
          className={`bg-white rounded-lg shadow-md border-l-4 ${
            message.status === "unread"
              ...
              : "border-green-600"
          } p-8 mb-6 transition-all duration-300 hover:shadow-lg`}
        >
          {" "}
          ...
          <div className="border-b pb-6 mb-6">
            ...
            <div className="flex flex-col md:flex-row justify-between md:items-start gap-4">
              <div className="bg-gray-50 p-4 rounded-lg w-full md:w-auto">
                {" "}
                {/* Añadido fondo y padding */}
                <p className="text-gray-700 mb-2">
                  <span className="font-semibold">De:</span> {message.name}
                </p>
                <p className="text-gray-700 mb-2">
                ...
                {message.has_been_replied && message.last_reply && (
                  <div className="mt-2 p-2 bg-blue-50 rounded border border-blue-100">
                    <p className="text-xs text-blue-700">
                      ...
                      {new Date(
                        message.last_reply.date.seconds * 1000
                      ).toLocaleString()}
                    </p>
                  </div>
                )}
              ...
              <div className="text-right bg-gray-50 p-4 rounded-lg w-full md:w-auto">
                {" "}
                {/* Añadido fondo y padding */}
          ...
          <div className="mb-6 text-gray-800 whitespace-pre-wrap bg-gray-50 p-6 rounded-lg border border-gray-100 text-lg">
            {" "}
            {/* Añadido estilo y tamaño */}
            {message.message}
          </div>
        </div>
