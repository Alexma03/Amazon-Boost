export const accountManagementData = {
  title: "Gestión de la Cuenta en Amazon: Maximiza tu Potencial de Venta",
  description: "La gestión eficiente de una cuenta de Amazon es clave para garantizar un crecimiento sostenible y evitar problemas que puedan afectar tus ventas. En AmazonBoost, nos encargamos de administrar tu cuenta de manera profesional, asegurando que cada aspecto de tu negocio en Amazon esté optimizado y cumpla con las normativas de la plataforma.",
  benefits: {
