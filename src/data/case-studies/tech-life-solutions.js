export const techLifeSolutionsData = {
  ...
  approach: [
    ...
    "Rediseñamos completamente sus listados con imágenes de mayor calidad, títulos optimizados para SEO y bullets de características que abordaban directamente las principales preocupaciones de los clientes.",
    "Desarrollamos una estrategia de precios dinámica para mantener la competitividad sin sacrificar los márgenes.",
    "Implementamos una campaña de PPC altamente específica con una estructura de campaña en tres niveles para maximizar la visibilidad y minimizar el desperdicio de presupuesto.",
    "Establecimos un programa de seguimiento post-compra para incrementar las reseñas orgánicas y mejorar la clasificación de las estrellas."
  ],
  results: {
    revenue: "+245%",
    ranking: "Top 3",
    conversion: "12.8%",
    additional: [
      { label: "Reducción de ACOS", value: "De 42% a 18%" },
      { label: "Aumento de reseñas", value: "+320% en 6 meses" },
      { label: "Participación de mercado", value: "Incremento del 15%" },
      { label: "ROI de publicidad", value: "5.2x" }
    ]
  },
  testimonial: {
